        ...
        <div className='container'>
          <div className='row content'>
            ...
            <div className='col-12 col-md-7 offset-xl-1 col-xl-7'>
              <h2 className='heading'>Een beetje over mij</h2>
              <p className='lead'>
              ...
              <p>
                ...
                mijn zus te helpen met het opruimen en opnieuw inrichten van haar kamer. Die liefde voor structuur en
                een nette omgeving is nooit verdwenen. Daarom besloot ik opleidingen te volgen tot
              ...
              <p>
                Toen ik zelf kinderen kreeg, merkte ik hoe snel spullen – zoals speelgoed – zich opstapelden. Het werd
                me duidelijk hoe een chaotisch huis onrust in je hoofd kan veroorzaken. Door op te ruimen, te
                minimaliseren en slimme structuren te creëren, ontdekte ik hoeveel rust en overzicht dat oplevert. En
                die ervaring wil ik nu met jou delen!
              </p>
              <p>
